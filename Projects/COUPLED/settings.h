...
// Grid set-up
#define DOMAIN_BITS 8 //< Domain resolution. 8 -> (2^8)^3 grid-nodes. Increase = finer grids.
...
struct MaterialConfigs {
  ...
  PREC xi;
  bool hardeningOn;
  PREC rhow, alpha1, poro, Kf, Ks, Kperm, init_pw;
  MaterialConfigs() : ppc(8.0), rho(1e3), bulk(2.2e7), visco(1e-3), gamma(7.1), E{1e7}, nu{0.3}, logJp0(0.), frictionAngle(30.), cohesion(0.), beta(0.5), volumeCorrection(false), xi(1.0), hardeningOn(true), rhow(1e3), alpha1(1.0), poro(0.2), Kf(10.0e7), Ks(1e7), Kperm(1e-2), init_pw(0.0) {}
